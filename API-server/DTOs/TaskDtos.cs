...
namespace ProductivityHub.DTOs
{
    public class TaskDTOs
    {
        ...
        // keeps both in sync.
        public record CreateTaskRequest(string Title, [MaxLength(2000)] string? Description, bool IsCompleted, DateOnly? DueDate);

        public record UpdateTaskRequest(string Title, [MaxLength(2000)] string? Description, bool IsCompleted, DateOnly? DueDate);
